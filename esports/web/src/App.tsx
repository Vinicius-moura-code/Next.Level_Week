import logo from './assets/Logologo-nlw.svg';
  ...
  return (
    <div className='max-w-[1344px] mx-auto flex flex-col items-center my-20'>
      ...
      <h1 className='text-6xl text-white font-black mt-20'>
        Seu{' '}
        <span className='text-transparent bg-nlw-gradient bg-clip-text drop-shadow-md shadow-black'>
          duo
        </span>{' '}
        está aqui.
      </h1>
      ...
      <div className='grid grid-cols-6 gap-6 mt-16'>
        <a href='' className='relative rounded-lg overflow-hidden'>
          ...
          <div className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0'>
            ...
            <span className='text-zinc-300 text-sm block mt-1'>3 anuncios</span>
          </div>
        </a>
      ...
      <div className='mt-8 pt-1 bg-nlw-gradient self-stretch rounded-lg overflow-hidden'>
        <div className='bg-[#2A2634] px-8 py-6 flex justify-between items-center'>
          ...
          <button className='py-4 px-3 bg-violet-500 hover:bg-violet-600 text-white rounded flex items-center gap-3'>
